...
class Admetmesh(models.Model):
    ...
    mdck = models.CharField(blank=True, null=True)
    ...
    lipinski = models.CharField(blank=True, null=True)
    pfizer = models.CharField(blank=True, null=True)
    gsk = models.CharField(blank=True, null=True)
    goldentriangle = models.CharField(blank=True, null=True)
...
class ClasseFarmaco(models.Model):
    ...
    vl_score = models.DecimalField(max_digits=10, decimal_places=5, blank=True, null=True)  # max_digits and decimal_places have been guessed, as this database handles decimal fields as float
...
class Fpocket(models.Model):
    id_pdb = models.CharField(blank=True, null=True)
...
class PlipHalogen(models.Model):
    ...
    restype_lig = models.CharField(blank=True, null=True)
    reschain_lig = models.CharField(blank=True, null=True)
    ...
    donortype = models.CharField(blank=True, null=True)
    acc_idx = models.IntegerField(blank=True, null=True)
    acceptortype = models.CharField(blank=True, null=True)
...
class PlipPistacking(models.Model):
    ...
    voffset = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    vtype = models.CharField(blank=True, null=True)
    lig_idx_list = models.CharField(blank=True, null=True)
    ligcoo = models.CharField(max_length=50, blank=True, null=True)
    protcoo = models.CharField(max_length=50, blank=True, null=True)
    score = models.FloatField()
...
class Proteins(models.Model):
    id_pdb = models.CharField(primary_key=True)
    nm_protein = models.CharField(max_length=20, blank=True, null=True)
...
class VsRaw(models.Model):
    id_pdb = models.CharField(primary_key=True)  # The composite primary key (id_pdb, id_pocket, nm_farmaco, nm_analogo) found, that is not supported. The first column is selected.
    id_pocket = models.CharField()
